...
import s from "./Style/MainListFilter.module.sass"
import { setExchangeParams } from "src/Store/Actions/ExchangeActions";

const MainListFilter: React.FC = (props) => {
  ...
  return (
    <div className={s.root}>
      <div className={s.container}>
        <div className={s.MainListFilter}>
          MainListFilter!
...
export default connect(exchangeCatch, mapDispatchToProps)(MainListFilter)